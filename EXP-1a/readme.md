...
![cal month command output](calmonth.png)
### CAL COMMAND MANUAL
...
### LS NAME * COMMAND OUTPUT
![ls name * command output](ls2.png)
### LS - A COMMAND OUTPUT
